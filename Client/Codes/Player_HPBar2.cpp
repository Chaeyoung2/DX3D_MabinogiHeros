#include "stdafx.h"
#include "..\Headers\Player_HPBar2.h"
#include "Component_Manager.h"
#include "Object_Manager.h"
#include "Shader.h"

CPlayer_HPBar2::CPlayer_HPBar2(LPDIRECT3DDEVICE9 pGraphicDev)
...
HRESULT CPlayer_HPBar2::Ready_GameObject(void)
{
	if (FAILED(Ready_Component()))
		return E_FAIL;
	m_fX = (float)g_iBackCX * 0.5f;
	m_fConstX = m_fX;
	m_fY = (float)g_iBackCY * 0.01f;
	m_fConstSizeX = 610.f;
	m_fSizeX = 610.0f;
	m_fSizeY = 13.0f;
...
_int CPlayer_HPBar2::Update_GameObject(const _float & fTimeDelta)
{
...
_int CPlayer_HPBar2::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CPlayer_HPBar2::Render_GameObject(void)
{
...
HRESULT CPlayer_HPBar2::Ready_Component(void)
{
	...
	// For.Com_Texture
	pComponent = m_pTextureCom = (CTexture*)m_pComponent_Manager->Clone_Component(SCENE_STAGE, L"Component_Texture_Player_HPBar2");
	if (nullptr == pComponent)
		return E_FAIL;
...
HRESULT CPlayer_HPBar2::SetUp_ConstantTable(LPD3DXEFFECT pEffect)
{
	pEffect->AddRef();
...
CPlayer_HPBar2 * CPlayer_HPBar2::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CPlayer_HPBar2 *	pInstance = new CPlayer_HPBar2(pGraphicDev);

	if (FAILED(pInstance->Ready_GameObject()))
	{
		MSG_BOX("CPlayer_HPBar2 Created Failed");
		Safe_Release(pInstance);
	}
	return pInstance;
}

_ulong CPlayer_HPBar2::Free(void)
{
