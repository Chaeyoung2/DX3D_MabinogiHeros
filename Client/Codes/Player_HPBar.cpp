#include "stdafx.h"
#include "..\Headers\Player_HPBar.h"
#include "Component_Manager.h"
#include "Object_Manager.h"
#include "Shader.h"

CPlayer_HPBar::CPlayer_HPBar(LPDIRECT3DDEVICE9 pGraphicDev)
...
HRESULT CPlayer_HPBar::Ready_GameObject(void)
{
...
_int CPlayer_HPBar::Update_GameObject(const _float & fTimeDelta)
{
...
_int CPlayer_HPBar::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CPlayer_HPBar::Render_GameObject(void)
{
...
HRESULT CPlayer_HPBar::Ready_Component(void)
{
	...
	// For.Com_Texture
	pComponent = m_pTextureCom = (CTexture*)m_pComponent_Manager->Clone_Component(SCENE_STAGE, L"Component_Texture_Player_HPBar1");
	if (nullptr == pComponent)
		return E_FAIL;
...
HRESULT CPlayer_HPBar::SetUp_ConstantTable(LPD3DXEFFECT pEffect)
{
	pEffect->AddRef();
...
CPlayer_HPBar * CPlayer_HPBar::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CPlayer_HPBar *	pInstance = new CPlayer_HPBar(pGraphicDev);

	if (FAILED(pInstance->Ready_GameObject()))
	{
		MSG_BOX("CPlayer_HPBar Created Failed");
		Safe_Release(pInstance);
	}
	return pInstance;
}

_ulong CPlayer_HPBar::Free(void)
{
