...
public:
	virtual HRESULT Ready_GameObject(ZECALLION_BONE eBoneID, _vec3 vBloodPosition, _int iDrawID, _vec3 vecAngle);
...
public:
	static CEffect_Hit* Create(LPDIRECT3DDEVICE9 pGraphicDev, ZECALLION_BONE eBoneID, _vec3 vBloodPosition, _int iDrawID, _vec3 vecAngle);
